...
* I’m heavily biased towards action. There’s value on having strategic discussions, but most of the time is best to start with small and quick iterations. This way, we can prove (or not) our assumptions (fail-fast to learn-fast) and make visible progress. Actions speak louder than words.
...
* Foster and nurture distributed ownership, whereby everyone is a business owner by developing guiding principles to simplify and decentralise decision-making.
...
* We’re a team. Our behaviours are conducive of a cohesive, effective and efficient team.
...
* Expect excellence in ourselves, and then, in each other.
...
I also recommend reading [The Coaching Habit: Say Less, Ask More & Change the Way You Lead Forever](https://www.amazon.co.uk/Coaching-Habit-Less-Change-Forever-ebook/dp/B01BUIBBZI/).
...
Meeting minutes to be shared during the week and be ratified by the team members. Minute to be written by a meeting historian or by a team member in a round-robin fashion.
...
Every 2 months we’ll hold a 1:1s retrospective. This way, we can continuously improve our chats.
...
Perhaps {company_X} has a delivery department or something similar. I expect you to work closely with them and be accountable for the quality and accuracy of what’s being reported of your teams.
...
I don’t expect you to respond to everything in real-time, but do expect you to close the loop on everything we open in a timely manner. If it’s on my plate, I will do the same. I get frustrated when I have to ask about something twice or if I’m asked about something that we’ve agreed you should have come back to me with.
...
If you suggest a meeting or discussion, initiate finding time on my diary and make the appointment. If I suggest a discussion, I will do the same. Don’t say “let’s discuss” without a quick follow-up of when we’ll discuss.
...
I always ask: If a team member were to be alerted at 4 am on a Friday to deal with an incident will she/he be able to identify, test and ship a hotfix by 4:30 am with a sense of fulfilled duty? If not, the team must get the system in a state that enables it.
...
Operational Excellence to me is the ability to run and monitor systems to deliver business value and to continually improve supporting processes and procedures at pace. **Operational Excellence is exceptionally close to my heart.** I expect you to have it front and centre as it’s key to meet customer expectations.
...
When innovation requires extensive work that impacts the product roadmap and/or other teams, it has to be discussed across Tech and/or Product. Put it down in writing so that we can have an asynchronous conversation first. I very fun of A3 thinking that’s usually used to find root causes issues. I find the template quite useful in tech. Still, I’m open to any format that you find helpful to express the idea.
